...
class BM25:
    def __init__(
        ...
        index_name: str = None,
        keys: Dict = {'title': 'title', 'body': 'txt'},
        ...
        **search_engine_kwargs,
        ...
        if engine == 'elasticsearch':
            ...
            self.retriever = EvaluateRetrieval(
                BM25Search(index_name=index_name, hostname='http://localhost:9200', 
                keys = keys, initialize=False, number_of_shards=1),
        ...
        req_body = {
            ...
            "query": {
                "multi_match": {
                    ...
                    "type": "best_fields",
                    "fields": [self.text_key, 'description', 'tags'],
                    "tie_breaker": 0.5
                    }
                },
